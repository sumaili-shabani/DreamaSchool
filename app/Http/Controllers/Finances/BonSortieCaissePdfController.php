    ...
    function getInfoFactureTug($id)
    {
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:727px;height:706px;position:relative;">
                    ...
                    <tr style="vertical-align:top;">
                        ...
                        <td class="cs62767105" colspan="8" style="width:180px;height:20px;line-height:18px;text-align:left;vertical-align:top;"></td>
                        <td class="csEBB30003" style="width:7px;height:26px;"></td>
                    </tr>
                    <tr style="vertical-align:top;">
                        <td style="width:0px;height:22px;"></td>
...
public function fetch_rapport_sortie_compte_date_rubrique(Request $request)
{
    //

    if ($request->get('date1') && $request->get('date2') && $request->get('refRubSortie'))  {
        // code...
        $date1 = $request->get('date1');
        $date2 = $request->get('date2');
        $refRubSortie = $request->get('refRubSortie');

        $html ='<html><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>';
        $html .= $this->printDataListCompte($date1, $date2,$refRubSortie);       
        // $html .='<script>window.print()</script>';
        // echo($html);  
        $pdf = \App::make('dompdf.wrapper');
        $pdf->loadHTML($html);
