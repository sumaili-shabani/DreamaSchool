    ...
    <v-dialog v-model="dialog" persistent max-width="400">
      <v-card>
        ...
        <v-form ref="form" lazy-validation>
          <v-card-title class="warning white--text" dark>
            {{ titleComponent }} <v-spacer></v-spacer>
            <v-btn depressed text small fab @click="dialog = false" dark>
              <v-icon>close</v-icon>
            </v-btn>
          </v-card-title>
                    ...
                    <v-list-item link>
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle
                          >Email: {{ item.email }}</v-list-item-subtitle
                        >
                        <v-list-item-content>
                          <p>Sexe: {{ item.sexe }}</p>
                          <p>Foncion et privilège: {{ item.role_name }}</p>
                        </v-list-item-content>
                      </v-list-item-content>
