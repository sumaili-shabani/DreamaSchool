                ...
                <v-dialog v-model="dialog" max-width="400px" scrollable transition="dialog-bottom-transition">
                    <v-card :loading="loading">
                        <v-form ref="form" lazy-validation>
                            ...
                            <v-card-text>
                                <v-text-field label="Nom du privilège" prepend-inner-icon="extension"
                                    :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense
                                    v-model="svData.nom"></v-text-field>
                            </v-card-text>
                            <v-card-actions>
                                <v-spacer></v-spacer>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr v-for="item in fetchData" :key="item.id">
                                ...
                                <td>
                                    <!-- <a class="product-img">
                                        <img :src="`${baseURL}/vuetheme/assets/img/brand/adidas.png`" alt="product" />
                                    </a> -->
                                    {{ item.nom }}
                                </td>
