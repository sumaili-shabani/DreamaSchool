                                ...
                                <v-layout row wrap>
                                    ...
                                    <v-flex xs12 sm12 md6 lg6>
                                        <div class="mr-1">
                                            <v-autocomplete label="Selectionnez la commune"
                                                ...
                                                dense outlined v-model="svData.idCommune" clearable chips>
                                            </v-autocomplete>
                                        </div>
                                    </v-flex>
                                    ...
                                    <v-flex xs12 sm12 md12 lg12>
                                        ...
                                        <div class="mr-1">
                                            ...
                                            <v-text-field label="Nom de quartier" prepend-inner-icon="extension"
                                                :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense
                                                v-model="svData.nomQuartier"></v-text-field>
