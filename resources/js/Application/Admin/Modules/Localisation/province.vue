                        ...
                        <v-form ref="form" lazy-validation>
                            ...
                            <v-card-text>
                                <v-select label="Selectionnez le Pays" prepend-inner-icon="mdi-map"
                                    ...
                                    item-value="id" outlined dense v-model="svData.idPays">
                                </v-select>
                                <v-text-field label="Nom de la province" prepend-inner-icon="extension"
                                    :rules="[(v) => !!v || 'Ce champ est requis']" outlined dense
                                    v-model="svData.nomProvince"></v-text-field>
                            </v-card-text>
                            <v-card-actions>
                                <v-spacer></v-spacer>
