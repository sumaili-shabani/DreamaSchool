    ...
    <div>
                                    ...
                                    <v-flex xs12 sm12 md12 lg12>
                                        <div class="mr-1">
                                            <v-text-field label="Désignation" prepend-inner-icon="extension"
                                                ...
                                                v-model="svData.nomCatCours"></v-text-field>
                                        </div>
                                    </v-flex>
                                </v-layout>
                            </v-card-text>
        ...
        <div class="page-header">
            <div class="page-title">
                <h4>Liste des Catégorie de cours</h4>
...
export default {
    ...
    methods: {
        ...
        showModal() {
            this.dialog = true;
            this.titleComponent = "Ajout de la catégorie de cours";
            this.edit = false;
        ...
        testTitle() {
            if (this.edit == true) {
                this.titleComponent = "modification de " + item.nomCatCours;
            } else {
        ...
        onPageChange() {
            this.fetch_data(`${this.apiBaseURL}/fetch_cat_cours?page=`);
        },
        ...
        validate() {
            if (this.$refs.form.validate()) {
                ...
                this.insertOrUpdate(
                    `${this.apiBaseURL}/insert_cat_cours`,
        ...
        editData(id) {
            this.editOrFetch(
                `${this.apiBaseURL}/fetch_single_cat_cours/${id}`
            ).then(({ data }) => {
        ...
        clearP(id) {
            this.confirmMsg().then(({ res }) => {
                this.delGlobal(`${this.apiBaseURL}/delete_cat_cours/${id}`).then(
                    ({ data }) => {
