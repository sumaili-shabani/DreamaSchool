                                ...
                                <v-row v-show="showDate">
                                    ...
                                    <v-col cols="12" sm="6">
                                        ...
                                        <v-layout row wrap>
                                                    ...
                                                    <v-tooltip bottom color="black">
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <span v-bind="attrs" v-on="on">
                                                                <v-btn @click="PrintRapportDetailPaiement()" block dark>
                                                                    <v-icon>print</v-icon> Rapport journalier des
                                                                    Paiements
                                                                </v-btn>
                                                            </span>
                                                        </template>
                                            ...
                                            <v-flex xs12 sm12 md12 lg12>
                                                <div class="mr-1" style="margin-top: 10px;">
                                                    <v-text-field label="Montant($) > 0u = à " type="number" min="0"
                                                        dense prepend-inner-icon="payments"
                                                        :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                                        v-model="svData.montant">
                                                    </v-text-field>
                                                </div>
                                            </v-flex>
                                                ...
                                                <div class="mr-1">
                                                    ...
                                                    <v-tooltip bottom color="black">
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <span v-bind="attrs" v-on="on">
                                                                <v-btn
                                                                    @click="printRapportRecouvrementClasse(svData.idAnne, svData.idOption, svData.idClasse, svData.montant)"
                                                                    block dark>
                                                                    <v-icon>print</v-icon> En Ordre avec {{ svData.montant }}$
                                                                    par classe
                                                                </v-btn>
                                                            </span>
                                                        </template>
                                                ...
                                                <div class="mr-1">
                                                    ...
                                                    <v-tooltip bottom color="black">
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <span v-bind="attrs" v-on="on">
                                                                <v-btn
                                                                    @click="printRapportRecouvrementOption(svData.idAnne, svData.idOption, svData.montant)"
                                                                    block dark>
                                                                    <v-icon>print</v-icon> En Ordre avec {{ svData.montant }}$
                                                                    par Option
                                                                </v-btn>
                                                ...
                                                <div class="mr-1">
                                                    <v-tooltip bottom color="black">
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <span v-bind="attrs" v-on="on">
                                                                <v-btn
                                                                    @click="printRapportRetardPaieClasse(svData.idAnne, svData.idOption, svData.idClasse, svData.montant)"
                                                                    block dark>
                                                                    <v-icon>print</v-icon> En Retad avec {{ svData.montant }}$
                                                                    par classe
                                                                </v-btn>
                                                            </span>
                                                        </template>
                                                ...
                                                <div class="mr-1">
                                                    ...
                                                    <v-tooltip bottom color="black">
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <span v-bind="attrs" v-on="on">
                                                                <v-btn
                                                                    @click="printRapportRetardPaieOption(svData.idAnne, svData.idOption, svData.montant)"
                                                                    block dark>
                                                                    <v-icon>print</v-icon> En Retad avec {{ svData.montant }}$
                                                                    par Option
                                                                </v-btn>
                                                        ...
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <span v-bind="attrs" v-on="on">
                                                                <v-btn
                                                                    ...
                                                                    block dark>
                                                                    <v-icon>print</v-icon> Prévision de paiement
                                                                    par classe
                                                                </v-btn>
                                                            </span>
                                                        </template>
                                                        <span> Rapport de Prevision de Paiement scollaire par
                                                            classe</span>
                                                    </v-tooltip>
                                                ...
                                                <div class="mr-1">
                                                    ...
                                                    <v-tooltip bottom color="black">
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <span v-bind="attrs" v-on="on">
                                                                <v-btn
                                                                    @click=" printBillPrevisionGenerale(svData.idAnne)"
                                                                    block dark>
                                                                    <v-icon>print</v-icon> Prevision de paiement
                                                                    générale
                                                                </v-btn>
                                                            </span>
                                                        </template>
                                            ...
                                            <v-flex xs12 sm12 md12 lg12>
                                                <div class="mr-1">
                                                    ...
                                                    <v-tooltip bottom color="black">
                                                        <template v-slot:activator="{ on, attrs }">
                                                            <span v-bind="attrs" v-on="on">
                                                                <v-btn @click="printBillEffectidRecette(svData.idAnne)"
                                                                    block dark>
                                                                    <v-icon>print</v-icon> Imprimer le tableau
                                                                    récapitilatif
                                                                </v-btn>
                                                            </span>
                                                        </template>
                                                        <span>Imprimer le rapport de tableau de recettes et des
                                                            effectifs </span>
                                                    </v-tooltip>
                                            ...
                                            <template v-slot:activator="{ on, attrs }">
                                                <span v-bind="attrs" v-on="on">
                                                    <v-btn
                                                        ...
                                                        block dark>
                                                        <v-icon>print</v-icon> Rapport Inscription par classe
                                                    </v-btn>
                                                </span>
                                            </template>
                                            <span> Rapport des Inscriptions par classe</span>
                                            ...
                                            <template v-slot:activator="{ on, attrs }">
                                                <span v-bind="attrs" v-on="on">
                                                    <v-btn
                                                        ...
                                                        block dark>
                                                        <v-icon>print</v-icon> Rapport Fiche Inscription par classe
                                                    </v-btn>
                                                </span>
                                            </template>
                                            ...
                                            <template v-slot:activator="{ on, attrs }">
                                                <span v-bind="attrs" v-on="on">
                                                    <v-btn
                                                        ...
                                                        block dark>
                                                        <v-icon>print</v-icon> Rapport mesure incitative par classe
                                                    </v-btn>
                                                </span>
                                            </template>
                                            <span> Rapport de Prise en charge par classe</span>
...
export default {
    ...
    methods: {
        ...
        printRapportRecouvrementClasse(idAnne, idOption, idClasse, montant) {
            if (idAnne != '' && idOption != '' && idClasse != '') {
                window.open(`${this.apiBaseURL}/fetch_rapport_recouvrement_classe?idAnne=${idAnne}&idOption=${idOption}&idClasse=${idClasse}&montant=${montant}`);
            } else {
        ...
        printRapportRecouvrementOption(idAnne, idOption, montant) {
            if (idAnne != '' && idOption != '') {
                window.open(`${this.apiBaseURL}/fetch_rapport_recouvrement_option?idAnne=${idAnne}&idOption=${idOption}&montant=${montant}`);
            } else {
        ...
        printRapportRetardPaieOption(idAnne, idOption, montant) {
            if (idAnne != '' && idOption != '') {
                window.open(`${this.apiBaseURL}/fetch_rapport_retardpaie_option?idAnne=${idAnne}&idOption=${idOption}&montant=${montant}`);
            } else {
        ...
        printRapportRetardPaieClasse(idAnne, idOption, idClasse, montant) {
            if (idAnne != '' && idOption != '' && idClasse != '') {
                window.open(`${this.apiBaseURL}/fetch_rapport_retardpaie_classe?idAnne=${idAnne}&idOption=${idOption}&idClasse=${idClasse}&montant=${montant}`);
            } else {
