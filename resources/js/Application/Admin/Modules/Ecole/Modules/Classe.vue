                                    ...
                                    <v-flex xs12 sm12 md12 lg12>
                                        <div class="mr-1">
                                            <v-text-field label="Désignation" prepend-inner-icon="extension"
                                                ...
                                                v-model="svData.nomClasse"></v-text-field>
                                        </div>
                                    </v-flex>
                                </v-layout>
                            </v-card-text>
...
export default {
    ...
    methods: {
        ...
        showModal() {
            this.dialog = true;
            this.titleComponent = "Ajout de classe";
            this.edit = false;
        ...
        testTitle() {
            if (this.edit == true) {
                this.titleComponent = "modification de " + item.nomClasse;
            } else {
                this.titleComponent = "Ajout de classe";
            }
        },
        ...
        onPageChange() {
            this.fetch_data(`${this.apiBaseURL}/fetch_classe?page=`);
        },
        ...
        editData(id) {
            this.editOrFetch(
                `${this.apiBaseURL}/fetch_single_classe/${id}`
            ).then(({ data }) => {
        ...
        clearP(id) {
            this.confirmMsg().then(({ res }) => {
                this.delGlobal(`${this.apiBaseURL}/delete_classe/${id}`).then(
                    ({ data }) => {
