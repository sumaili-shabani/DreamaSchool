                                    ...
                                    <v-flex xs12 sm12 md12 lg12>
                                        <div class="mr-1">
                                            <v-text-field label="Désignation" prepend-inner-icon="extension"
                                                ...
                                                v-model="svData.nomTypeTranche"></v-text-field>
                                        </div>
                                    </v-flex>
                                </v-layout>
                            </v-card-text>
...
export default {
    ...
    methods: {
        ...
        showModal() {
            this.dialog = true;
            this.titleComponent = "Ajout de frais";
            this.edit = false;
        ...
        testTitle() {
            if (this.edit == true) {
                this.titleComponent = "modification de " + item.nomTypeTranche;
            } else {
                this.titleComponent = "Ajout de frais";
            }
        },
        ...
        onPageChange() {
            this.fetch_data(`${this.apiBaseURL}/fetch_type_tranche?page=`);
        },
        ...
        validate() {
            if (this.$refs.form.validate()) {
                ...
                this.insertOrUpdate(
                    `${this.apiBaseURL}/insert_type_tranche`,
        ...
        editData(id) {
            this.editOrFetch(
                `${this.apiBaseURL}/fetch_single_type_tranche/${id}`
            ).then(({ data }) => {
        ...
        clearP(id) {
            this.confirmMsg().then(({ res }) => {
                this.delGlobal(`${this.apiBaseURL}/delete_type_tranche/${id}`).then(
                    ({ data }) => {
