                                    ...
                                    <v-flex xs12 sm12 md12 lg12>
                                        <div class="mr-1">
                                            <v-text-field label="Désignation" prepend-inner-icon="extension"
                                                ...
                                                v-model="svData.nomTranche"></v-text-field>
                                        </div>
                                    </v-flex>
                                </v-layout>
                            </v-card-text>
...
export default {
    ...
    methods: {
        ...
        onPageChange() {
            this.fetch_data(`${this.apiBaseURL}/fetch_tranche?page=`);
        },
        ...
        validate() {
            if (this.$refs.form.validate()) {
                ...
                this.insertOrUpdate(
                    `${this.apiBaseURL}/insert_tranche`,
        ...
        editData(id) {
            this.editOrFetch(
                `${this.apiBaseURL}/fetch_single_tranche/${id}`
            ).then(({ data }) => {
        ...
        clearP(id) {
            this.confirmMsg().then(({ res }) => {
                this.delGlobal(`${this.apiBaseURL}/delete_tranche/${id}`).then(
                    ({ data }) => {
