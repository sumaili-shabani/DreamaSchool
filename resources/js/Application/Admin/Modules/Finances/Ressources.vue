                        ...
                        <v-form ref="form" lazy-validation>
                            ...
                            <v-card-text>
                                ...
                                <v-layout row wrap>
                                    ...
                                    <v-flex xs12 sm12 md12 lg12>
                                        <div class="mr-1">
                                            <v-autocomplete label="Selectionnez le Mode de Paiement"
                                                ...
                                                :rules="[(v) => !!v || 'Ce champ est requis']" :items="ModeList"
                                    ...
                                    <v-flex xs12 sm12 md6 lg6>
                                        <div class="mr-1">
                                            ...
                                            <v-autocomplete label="Selectionnez le Compte"
                                                ...
                                                item-text="designation" item-value="id" outlined dense
                                                v-model="svData.refCompte">
                                            </v-autocomplete>
                                    ...
                                    <v-flex xs12 sm12 md6 lg6>
                                        <div class="mr-1">
                                            <v-text-field type="date" label="Date Entrée" prepend-inner-icon="event"
                                    ...
                                    <v-flex xs12 sm12 md12 lg12>
                                        <div class="mr-1">
                                            ...
                                            <v-text-field type="number" min="0.01" label="Montant($)"
                                                prepend-inner-icon="payments" dense
                                                :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr v-for="item in fetchData" :key="item.id">
                                <!-- <td>{{ item.codeOperation | subStrLong }}</td> -->
                                    ...
                                    <v-menu bottom rounded offset-y transition="scale-transition">
                                        ...
                                        <v-list dense width="">
                                            ...
                                            <v-list-item
                                                ...
                                                link @click="printBill(item.id)">
                                                <v-list-item-icon>
                                                    <v-icon color="blue">print</v-icon>
                                                </v-list-item-icon>
                                                <v-list-item-title style="margin-left: 5px">Bon
                                                    d'Entrée</v-list-item-title>
                                            </v-list-item>
...
export default {
    ...
    computed: {
        ...mapGetters(["categoryList", "ModeList", "compteList", "isloading"]),
    },
    methods: {

        ...mapActions(["getCategory", "getModeList", "getCompteList"]),
